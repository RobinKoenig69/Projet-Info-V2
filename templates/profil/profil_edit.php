...
if (isset($email)) {
    ...
    $sql = "SELECT nom, prenom, email, num_tel, photo_profil, user_type, Photo_Permis, pwd FROM utilisateur WHERE user_ID = :user_ID";
...
// Check input errors before inserting in database
    if (empty($nom_err) && empty($prenom_err) && empty($email_err) && empty($num_tel_err) && empty($password_err)) {
        ...
        $sql = "UPDATE utilisateur SET nom = :nom, prenom = :prenom, email = :email, num_tel = :num_tel, updated_at = :updated_at, pwd =:password WHERE user_ID = :user_ID";
